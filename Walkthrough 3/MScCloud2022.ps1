...
$ADUsers = Import-csv C:\PowerShell\Walkthrough3\MScCloud2022.csv

# Typo in the domain name!!!!
$Organisation = "DC=ads,DC=solarsubmaines,DC=com"
$Classgroup = "MScCloud2022"
...
New-ADGroup -Name $Classgroup -Description "MSc Cloud 2022" -GroupCategory Security -GroupScope DomainLocal -Path "OU=Groups, OU=$Classgroup,$Organisation"
...
foreach ($User in $ADUsers)
{
       ...
       else
       {
            ...
            Set-ADUser -Identity $Username -Description "MSc Student" -Organization "ATU"
